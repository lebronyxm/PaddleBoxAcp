...
#define EXPAND_EMBED_PULL_NNCROSS(i, ...)                                      \
  ...
  switch (hidden_size - cvm_offset_) {
    ...
    EMBEDX_CASE(2, EXPAND_EMBED_PULL_CASE2(0););
    EMBEDX_CASE(4, EXPAND_EMBED_PULL_CASE2(0););
...
#define EXPAND_EMBED_PUSH_NNCROSS(i, ...)                                      \
  ...
  switch (hidden_size - cvm_offset_) {
    ...
    EMBEDX_CASE(2, EXPAND_EMBED_PUSH_CASE2(0););
    EMBEDX_CASE(4, EXPAND_EMBED_PUSH_CASE2(0););
